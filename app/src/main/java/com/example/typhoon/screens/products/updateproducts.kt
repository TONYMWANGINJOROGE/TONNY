package com.example.typhoon.screens.products//package com.example.typhoon.screens.products
...
////import com.example.brabas.data.ProductViewModel
import com.example.typhoon.models.Product
import com.example.typhoon.navigate.ROUTE_VIEW_PRODUCT
//import com.example.brabas.navigate.ROUTE_VIEW_PRODUCT
//import com.example.typhoon.data.ProductViewModel
//import com.example.typhoon.data.ProductViewModel
...
fun UpdateProductsScreen(navController: NavHostController,id:String) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var productColor by remember{ mutableStateOf(TextFieldValue(price)) }
        ...
        Button(onClick = {
            ...
            productRepository.updateProduct(productName.text.trim(),productQuantity.text.trim(),
                productPrice.text.trim(),id,productColor.text.trim())
